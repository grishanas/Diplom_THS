...
namespace backend_.Controllers.MCController
{
    ...
    [ApiController]
    public class ControllerOutputGroupController : ControllerBase
    {


        private readonly ControllerOutputGroupDBContext _dbContext;
        private readonly m2mControllerOutputGroupDBContext _m2mOutputGroup;

        public ControllerOutputGroupController(ControllerOutputGroupDBContext dbContext)
        {
